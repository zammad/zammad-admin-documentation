...
By clicking on "custom objects" you can edit them to suit your needs.
   ...
   .. note::
      ...
      Objects you add to Zammad, no matter if they have default values or not,
      will not update existing information. This means a new ticket field
      technically will be empty unless you populate it.

      Especially in ticket scope this also means that newly added objects will
      be indicated as "changed" to agents that view the ticket. This may
