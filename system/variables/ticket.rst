...
.. csv-table:: Ticket Variables
   ...
   "Ticket > Updated by > Avatar", "``#{ticket.updated_by.avatar(60,60)}``", "avatar picture in defined size (e.g. 60,60)"
   ...
   "Ticket > Owner > Avatar", "``#{ticket.owner.avatar(60,60)}``", "avatar picture in defined size (e.g. 60,60)"
   ...
   "Ticket > Customer > Avatar", "``#{ticket.customer.avatar(60,60)}``", "avatar picture in defined size (e.g. 60,60)"
   ...
   "Ticket > Created by > Avatar", "``#{ticket.created_by.avatar(60,60)}``", "avatar picture in defined size (e.g. 60,60)"
